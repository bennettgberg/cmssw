...
class Py8PlutoReaderExpGun : public Py8GunBase {
   
   public:
      
      Py8PlutoReaderExpGun( edm::ParameterSet const& );
      ~Py8PlutoReaderExpGun() override {}
...
// implementation 
//
Py8PlutoReaderExpGun::Py8PlutoReaderExpGun( edm::ParameterSet const& ps )
   ...
   std::cout << "[Py8PlutoReaderExpGun constructor] Begin reading Pluto input file..." << std::endl;
   ...
   infile.close();
   std::cout << "[Py8PlutoReaderExpGun constructor] Finished reading Pluto input file!" << std::endl;
}


bool Py8PlutoReaderExpGun::generatePartonsAndHadronize()
{
...
const char* Py8PlutoReaderExpGun::classname() const
{
   return "Py8PlutoReaderExpGun"; 
}

typedef edm::GeneratorFilter<gen::Py8PlutoReaderExpGun, gen::ExternalDecayDriver> Pythia8PlutoReaderExpGun;

} // end namespace

using gen::Pythia8PlutoReaderExpGun;
DEFINE_FWK_MODULE(Pythia8PlutoReaderExpGun);
